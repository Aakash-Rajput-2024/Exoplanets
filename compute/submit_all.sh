...
#   bash compute/submit_all.sh              # submit all 15 jobs
#   bash compute/submit_all.sh --dry-run    # just print what would run
#   bash compute/submit_all.sh --only transformerarch  # single track, 3 seeds
#
