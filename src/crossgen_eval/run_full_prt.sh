...
LOGDIR="$REPO/src/crossgen_eval/prt_logs"
mkdir -p "$LOGDIR"
...
echo "=== [3/6] ==="; crosstest "$REPO/src/transformerarch/crosstest.py"   transformer
echo "=== [4/6] ==="; crosstest "$REPO/src/original1dcnn/crosstest.py"     original1dcnn
echo "=== [5/6] ==="; crosstest "$REPO/src/causal/cnn_trnas/crosstest.py"  causal
