...
It writes to src/crossgen_eval/results_v2_prt/<track><suffix>/ and NEVER touches
...
Run in venvNLP (torch):
  python src/crossgen_eval/crosstest_v2.py                 # all tracks + transformer grey
  python src/crossgen_eval/crosstest_v2.py --only causal
"""
import os
import sys
import json
...
RESULTS_ROOT = os.path.join(REPO, "src", "crossgen_eval", "results_v2_prt")
